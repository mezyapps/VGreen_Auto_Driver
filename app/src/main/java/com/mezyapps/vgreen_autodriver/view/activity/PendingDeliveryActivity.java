...
public class PendingDeliveryActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewPendingDelivery;
    ...
    private void find_View_IDs() {
        ...
        showProgressDialog = new ShowProgressDialog(PendingDeliveryActivity.this);
        ...
        recyclerViewPendingDelivery = findViewById(R.id.recyclerViewPendingDelivery);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(PendingDeliveryActivity.this);
        recyclerViewPendingDelivery.setLayoutManager(linearLayoutManager);
        user_id = SharedLoginUtils.getUserId(PendingDeliveryActivity.this);
    }

    private void events() {
        if (NetworkUtils.isNetworkAvailable(PendingDeliveryActivity.this)) {
            callPendingOrder();
        } else {
            NetworkUtils.isNetworkNotAvailable(PendingDeliveryActivity.this);
        }
    ...
    private void callPendingOrder() {
        showProgressDialog.showDialog();
        Call<SuccessModel> call = apiInterface.pendingOrder(user_id);
                        ...
                        if (successModule != null) {
                            ...
                            if (code.equalsIgnoreCase("1")) {
                                ...
                                if (commonDeliveryModelArrayList.size() != 0) {
                                    ...
                                    commonDeliveryAdapter = new CommonDeliveryAdapter(PendingDeliveryActivity.this, commonDeliveryModelArrayList);
                                    recyclerViewPendingDelivery.setAdapter(commonDeliveryAdapter);
