...
public class ShippedOrderActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewShippedDelivery;
    ...
    private void find_View_IdS() {
        ...
        showProgressDialog = new ShowProgressDialog(ShippedOrderActivity.this);
        iv_back = findViewById(R.id.iv_back);
        recyclerViewShippedDelivery = findViewById(R.id.recyclerViewShippedDelivery);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ShippedOrderActivity.this);
        recyclerViewShippedDelivery.setLayoutManager(linearLayoutManager);
        user_id = SharedLoginUtils.getUserId(ShippedOrderActivity.this);
    }

    private void events() {
        if (NetworkUtils.isNetworkAvailable(ShippedOrderActivity.this)) {
            calShippedOrder();
        } else {
            NetworkUtils.isNetworkNotAvailable(ShippedOrderActivity.this);
        }
    ...
    private void calShippedOrder() {
        showProgressDialog.showDialog();
        Call<SuccessModel> call = apiInterface.shippedOrder(user_id);
                        ...
                        if (successModule != null) {
                            ...
                            if (code.equalsIgnoreCase("1")) {
                                ...
                                if (commonDeliveryModelArrayList.size() != 0) {
                                    ...
                                    commonDeliveryAdapter = new CommonDeliveryAdapter(ShippedOrderActivity.this, commonDeliveryModelArrayList);
                                    recyclerViewShippedDelivery.setAdapter(commonDeliveryAdapter);
